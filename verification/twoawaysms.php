                                        ...
                                        <div  class="">
                                            ...
                                            <div class="pagination-view animate has-identity-banner slide-in-next" >
                                                ...
                                                <div data-viewid="1" data-showidentitybanner="true" >
                                                    ...
                                                    <div id="idDiv_SAOTCC_Title" class="row text-title" role="heading" aria-level="1" >Approve sign in request</div>
                                                    <div class="row text-body">
                                                        <div >
                                                            <img class="tile-img small animate-pulse" role="presentation" pngsrc="https://aadcdn.msftauth.net/shared/1.0/content/images/picker_verify_call_3fb9c7e87c04ff8f56dd61ef8b748c02.png" svgsrc="https://aadcdn.msftauth.net/shared/1.0/content/images/picker_verify_call_fe87496cc7a44412f7893a72099c120a.svg"  src="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_call_fe87496cc7a44412f7893a72099c120a.svg">
                                                        </div>
                                                        <div id=" idDiv_SAOTCC_Description" class="text-block-body overflow-hidden" >We're calling your phone. Please answer it to continue.
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="win-button-pin-bottom" >
                                                        <div class="row" >
                                                            <div >
                                                                <div class="col-xs-24 no-padding-left-right button-container no-margin-bottom"  style="display: none;">

                                                                    <div >
                                                                        <input type="submit" id="idSubmit_SAOTCC_Continue" class="win-button button_primary button ext-button primary ext-primary" data-report-event="Signin_Submit" data-report-trigger="click" data-report-value="Submit"  value="Verify" style="display: none;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
